  ...
  return (
    <div>
      ...
      <Col xs={6} md={4}>
        ...
        <Link to="/computers" className='button-link'>
        <Button variant="light" className="d-flex flex-column align-items-center">
          <span style={{ marginBottom: '0.5rem' }}>Computers</span> 
      ...
      <Link to="/televisions" className='button-link'>
      <Button variant="light" className="d-flex flex-column align-items-center">
        <span style={{ marginBottom: '0.5rem' }}>TVs</span> 
      ...
      <Link to="/sound" className='button-link'>
     <Button variant="light" className="d-flex flex-column align-items-center">
        <span style={{ marginBottom: '0.5rem' }}>Sound</span> 
      ...
      <Link to="/gaming" className='button-link'>
         <Button variant="light" className="d-flex flex-column align-items-center">
        <span style={{ marginBottom: '0.5rem' }}>Gaming</span> 
            ...
            <div className='background-wrapper'>
              <div className='content-wrapper'>
                <div className='hero-text'>
                  <p>
                    Amazing. Affordable. Future-Ready. Get your TV upgrade today!
                  </p>
                </div>
                <div className='hero-img'> 
                  <Image src={TV} fluid width={500} />
                </div>
              </div>
            </div>
          </Col>
